export default function CardTow({cardInfo}:{cardInfo: any}) {
    return (
        <div className="m-auto relative max-w-max smallPhone:w-[calc(100vw-2rem)]">
            <svg className="max-w-full transform scale-[0.99] h-auto" max={'100%'} width="416" height="278" viewBox="0 0 416 278" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full h-full absolute top-0 hover:translate-x-[5px] hover:translate-y-[-5px]">
                <div className="w-full h-full relative">
                    ...
                    <div className="h-full w-full flex flex-col justify-between px-10 py-8 pb-4 absolute top-0 left-0 smallPhone:px-5 smallPhone:py-4">
                        <div>
                        ...
                        <div className="font-neuemachina mb-2 flex flex-col items-center justify-between mt-8 smallPhone:mt-4 divide-y divide-[#282828] space-y-2 *:w-full *:pt-2 *:flex *:items-center *:justify-between">
                        {
